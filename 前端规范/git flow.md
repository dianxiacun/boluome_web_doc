...
### Git下的冲突问题
##### &emsp; 冲突的产生
&emsp; 多人协调开发的情况下，在merge和patch的时候有可能会发生冲突。
##### &emsp; 冲突的类型
&emsp; 这些冲突具体可以分成三种类型：逻辑冲突，内容冲突，树冲突。
##### &emsp; 冲突的解决
&emsp; 常见的解决方案是直接编辑冲突文件，找到冲突的文件，然后手动删除冲突标记，再和另一个操作过的人经过沟通后商量，把冲突解决成当前正确的状态。
&emsp; 冲突产生后，文件系统中冲突了的文件里面的内容会显示为类似下面这样：
```
  a123
  <<<<<<< HEAD
  b789
...
&emsp; 其中：冲突标记<<<<<<< （7个<）与=======之间的内容是我的修改，=======与>>>>>>>之间的内容是别人的修改。

&emsp; 具体可以参考：[多人开发时Git下冲突的产生和解决](http://blog.csdn.net/mad1989/article/details/16885569)
